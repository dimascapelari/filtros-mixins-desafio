...
export default {
  ...
  filters: {
    espacoPorVirgula(valor) {
      return valor.replace(/\s/g, ","); // troca espaço vazio por vírgula
    },
  },
};
</script>
